...
Usage (from the repository root)::
    ...
    python scripts/make_fig6.py --results-dir output/experiments/nppad_atsf_full \
        --out output/figures/diagnostics_panels/fig7_diagnostics.png
    (generator stem fig7_*; paper copy is fig08_* via main.py)
...
Writes:
    fig7_diagnostics.png (300 dpi) and fig7_diagnostics.svg (vector)
"""
...
def main() -> None:
    ...
    ap.add_argument("--out",
                    default=str(FIGURES_ROOT / "diagnostics_panels" / "fig7_diagnostics.png"))
    args = ap.parse_args()

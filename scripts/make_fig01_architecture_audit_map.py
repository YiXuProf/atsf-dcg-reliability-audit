...
Outputs:
    output/figures/architecture/fig01_architecture_audit_map.png   (300 dpi)
    output/figures/architecture/fig01_architecture_audit_map.svg
"""
import os
import sys
...
OUT = str(OUT_DIR / "fig01_architecture_audit_map")
